...
class DailyQuizWorker(
    ...
    companion object {
        fun schedule(context: Context) {
            ...
            val dailyWorkRequest = OneTimeWorkRequestBuilder<DailyQuizWorker>()
            ...
            if (calendarNow.after(calendar9AM)) {
                val todayWorkRequest = OneTimeWorkRequestBuilder<DailyQuizWorker>().build()
                WorkManager.getInstance(context).enqueueUniqueWork(
                    "DailyQuizWorker_Missed",
